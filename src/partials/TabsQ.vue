    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12" data-aos-id-tabs>
          ...
          >
            Cambieremo il modo di vendere, spedire, gestire, promuovere,
            acquistare all’ingrosso e informare.
          </h2>
        </div>
    ...
    return {
      ...
      cardItems: [
        ...
        },
        {
          ...
          content:
            "È la testata giornalistica del gruppo. Finanza, Fisco, Lavoro ed Economia. Questo prodotto editoriale avrà però molte novità, non sarà un classico quotidiano.",
        },
      ],
    };
  },
