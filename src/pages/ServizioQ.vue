        ...
        <div class="md:py-20 border-t border-gray-800">
          ...
          >
            ...
            <article
              ...
              data-aos="fade-up"
              v-for="service in destination.correlati"
              :key="service.slug"
            >
              <div class="grow flex flex-col h-full p-6 bg-gray-800">
                <h3 class="h4 mb-2">
                  <div
                    class="hover:text-purple-600 text-gray-900 transition duration-150 ease-in-out capitalize"
                  >
                    {{ service.name }}
                  </div>
                </h3>
                ...
                <div>
                  <router-link
                    ...
                    :to="`${service.slug}`"
                  >
                    <router-link :to="`/${service.slug}`" class="text-sm"
                      >Scopri</router-link
                    >
                    <svg
...
export default {
  ...
  computed: {
    ...
    destination() {
      return sourceData.servizi.find(
        (servizi) => servizi.slug === this.destinationSlug
      );
    },
  },
